...
extension LauncherDeveloperActions on LauncherBloc {
  ...
  Future<void> _onDeveloperUgcSettingsSaved(
    ...
    await _guard(emit, 'Saved UGC live-sync settings.', () async {
      ...
      final updated = await repository.loadDeveloperWorkspace(
  ...
  Future<void> _onDeveloperUgcConfigDeployed(
    ...
    await _guard(emit, 'Deployed UGC config to the game.', () async {
