              ...
              OutlinedButton.icon(
                onPressed: state.installedMods.isEmpty
                    ...
                    : () => _confirm(
                        ...
                        message:
                            'Robotopia will need a restart before loaded C# assemblies change.',
                  ...
                  child: BorderedPane(
                    child: selected == null
                        ? const EmptyStatePanel(
                            ...
                            brandAsset: QuantumWorksBrandAssets.sheriff,
                          )
    ...
    return BorderedPane(
      ...
      child: state.filteredMods.isEmpty
          ? const EmptyStatePanel(
              ...
              message:
                  'Install a .robotopiamod package or process the package inbox.',
              ...
              itemBuilder: (context, index) {
                ...
                return Material(
                  color: selected?.id == mod.id
                      ? QuantumWorksPalette.surfaceAlt
                      : Colors.transparent,
                  child: ListTile(
          ...
          children: [
            ...
            if (mod.uninstallPending)
              const StatusPill(
                ...
                tooltip:
                    'Package files will be removed when Robotopia next starts.',
              ),
          ],
        ),
