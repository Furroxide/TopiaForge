...
class WindowsPackageSigner {
  ...
  List<String> _releaseTargets(String stageRoot) => [
    p.join(stageRoot, 'robotopia.exe'),
    p.join(stageRoot, 'Robotopia.GameCompat.Extractor.exe'),
    p.join(stageRoot, 'launcher', 'robotopia_launcher_flutter.exe'),
