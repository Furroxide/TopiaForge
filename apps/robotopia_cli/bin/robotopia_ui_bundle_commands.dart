...
extension _RobotopiaUiBundleCommands on _RobotopiaCli {
  Future<int> _unityBuildUiBundle(List<String> args) async {
    ...
    if (dryRun) {
      ...
      stdout.writeln(
        'Build editor:  ${editor == null ? '(none eligible — need Unity ${RobotopiaUnityCompatibility.requiredEditorVersion})' : '${editor.version} at ${editor.path}'}',
      );
      stdout.writeln(
    ...
    if (explicitPath != null) {
      ...
      if (!WorldBundleEditorGate.isEligible(version)) {
        stderr.writeln(
          ...
          'Unity ${RobotopiaUnityCompatibility.requiredEditorDisplay}.',
        );
        return null;
      }
