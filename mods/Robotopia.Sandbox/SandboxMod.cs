...
{
    /// <summary>
    /// The Sandbox gamemode content layer. Robotopia Worlds owns the Open Sandbox world/arena and registers
    ...
    /// </summary>
    public sealed class SandboxMod : IRobotopiaMod
    {
        // Owned by Robotopia.Worlds (WorldsService.SandboxGamemodeId). Kept as a local constant so this mod
        // binds to the stable id, not to the Worlds assembly.
        public const string GamemodeId = "robotopia.worlds.sandbox";
        ...
        public void OnLoad(IModContext context)
        {
            ...
            if (worlds == null)
            {
                context.Logger.Warn("Robotopia Worlds service is not available; the Sandbox gamemode stays vanilla.");
                return;
            }
