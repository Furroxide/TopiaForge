...
{
    /// <summary>
    /// Clean-room build-2478 catalog adapters. Discovery is deliberately limited to the game's equippable-item
    ...
    internal sealed partial class CreatorBuiltInCatalog : IDisposable
    {
        ...
        private Discovery Discover()
        {
            ...
            result.Statuses["robotopia.vehicles"] = new CreatorCatalogSourceStatus(
                ...
                "No validated build-2478 vehicle registry adapter is available; arbitrary native scanning is disabled.",
                0);
            ...
            try
            {
                    ...
                    || iterEntries == null || prefabField == null)
                {
                    result.Statuses[ItemsSourceId] = new CreatorCatalogSourceStatus(
                        ...
                        displayName,
                        CreatorCatalogSourceState.Unavailable,
                        "The build-2478 equippable-item registry binding is missing or changed.",
                        0);
                    return;
                }
                ...
                if (entries != null)
                {
                    foreach (var entry in entries)
                    {
                        ...
                        result.Add(new Candidate(
                            ...
                            "Robotopia equippable item exposed by the build-2478 item registry.",
            ...
            try
            {
                    ...
                    || assetUri == null || assetPrefab == null || localPositionOffset == null)
                {
                    result.Statuses[PropsSourceId] = new CreatorCatalogSourceStatus(
                        ...
                        displayName,
                        CreatorCatalogSourceState.Unavailable,
                        "The curated build-2478 UGC prefab-map binding is missing or changed.",
                        0);
                    return;
                }
