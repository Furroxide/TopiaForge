...
using System.Linq;
using System.Text;
using Robotopia.UgcCompanion.Editor;
using Robotopia.VpmResolver;
using Robotopia.WorldCompanion.Editor;
...
namespace Robotopia.ModManager.Tests
{
    internal static class UnityToolingFileIoTests
    {
        ...
        {
            var seed = Path.Combine(directory, "RobotopiaUgcCompanion.json");
        ...
        private static void SourceContractsRemainWired()
        {
            ...
            var world = File.ReadAllText(Path.Combine(
                root,
                "templates", "Robotopia.UnityWorldTemplate", "Packages",
                "com.robotopia.world-companion", "Editor", "WorldBundleBuilder.cs"));
            var vpm = File.ReadAllText(Path.Combine(
                root,
                "templates", "Robotopia.UnityWorldTemplate", "Packages",
                "com.robotopia.vpm-resolver", "Editor", "VpmResolver.cs"));
            var seed = File.ReadAllText(Path.Combine(
                root,
                "templates", "unity-companion", "Packages",
                "com.robotopia.ugc-companion", "Editor", "UgcCompanionSeed.cs"));
