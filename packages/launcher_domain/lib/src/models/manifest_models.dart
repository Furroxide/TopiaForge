...
class ModManifest {
  ...
  /// Decodes a V6 manifest after rejecting retired schema versions before any
    ...
    if (schemaVersion == 4 || schemaVersion == 5) {
      return [
        LauncherIssue(
          ...
          message:
              'schemaVersion $schemaVersion was retired before TopiaForge 1.0; run `topiaforge migrate-manifest` to migrate to schemaVersion 6.',
        ),
      ];
    }
