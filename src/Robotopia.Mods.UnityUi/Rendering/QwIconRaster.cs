...
namespace Robotopia.Mods.UnityUi
{
    ...
    /// QwSprites when it fills the atlas.
    /// </summary>
    public static class QwIconRaster
    {
        ...
        public static float Coverage(QwIcon icon, float px, float py, int size)
        {
            var x = px / size;
            var y = py / size;
