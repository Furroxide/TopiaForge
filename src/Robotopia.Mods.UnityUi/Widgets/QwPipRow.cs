...
namespace Robotopia.Mods.UnityUi
{
    ...
    /// </summary>
    public sealed class QwPipRow : QwWidget, IQwThemeAware
    {
        ...
        private QwTone filledTone = QwTone.Accent;

        internal QwPipRow(QwContainer parent)
