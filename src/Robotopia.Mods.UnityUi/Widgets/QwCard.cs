...
namespace Robotopia.Mods.UnityUi
{
    ...
    ///
    /// Pooling note: <see cref="QwWidget.SetVisible"/> hides via CanvasGroup, so a
    ...
    /// </summary>
    public sealed class QwCard : QwWidget, IQwThemeAware
    {
        ...
        private QwTone badgeTone = QwTone.Neutral;
        private Texture? previewTexture;
        private QwIcon placeholderIcon = QwIcon.Grip;
        private bool selected;
        private bool hovered;
        private bool enabledState = true;

        internal QwCard(QwContainer parent, string title, Action onClick)
            : base(parent.Host, parent.Scheme, parent.CreateChildGameObject("Card"))
        {
            ...
            shadow = CreateStretched(Go.transform, "Shadow", QwSprites.Fill(QwRadius.Control), sliced: true);
            ...
            fill = CreateStretched(body, "Fill", QwSprites.Fill(QwRadius.Control), sliced: true);
            fill.raycastTarget = true;
            ring = CreateStretched(body, "Ring", QwSprites.Ring(QwRadius.Control, QwTokens.BorderStandard), sliced: true);
            ...
            previewFrame.sprite = QwSprites.Fill(QwRadius.Chip);
            ...
            caption = QwTmp.Create(captionGo);
            caption.fontSize = QwTokens.CaptionSize;
            ...
            badgeFill.sprite = QwSprites.Fill(QwRadius.Chip);
            ...
            QwAnchors.Stretch((RectTransform)badgeLabelGo.transform, 4f, 1f, 4f, 1f);
        ...
        public void SetBadge(string text, QwTone tone)
        {
        ...
        public void SetPreviewIcon(QwIcon icon)
        {
            ...
            placeholder.sprite = QwSprites.Icon(icon);
        }
        ...
        public void ApplyTheme(QwResolvedTheme theme)
        {
            ...
            badgeLabel.color = badgeTone == QwTone.Neutral ? theme.TextMuted : accent;
        }
    ...
    internal sealed class QwHoverNotifier : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
