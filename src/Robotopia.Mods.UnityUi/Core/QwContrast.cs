...
namespace Robotopia.Mods.UnityUi
{
    ...
    /// </summary>
    public static class QwContrast
    {
        /// <summary>
        ...
        /// </summary>
        public static QwRgba Emphasize(QwRgba color)
        {
        ...
        public static float Luminance(QwRgba color)
        {
        ...
        public static float Ratio(QwRgba a, QwRgba b)
        {
            var la = Luminance(a);
            var lb = Luminance(b);
        ...
        /// </summary>
        public static QwRgba DarkenForPaper(QwRgba accent, QwRgba surface, float minimumRatio = 4.5f)
        {
            var current = accent;
