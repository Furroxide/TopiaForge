namespace TopiaForge.Mods
{
    ...
    public interface IModContext
    {
        ...
        /// <summary>Gets content-based access to package and persistent data files.</summary>
        IModFiles Files { get; }

        /// <summary>Gets validated, versioned typed configuration persistence.</summary>
        IModConfigService Config { get; }

        /// <summary>Gets typed key-value persistence scoped to this mod.</summary>
        IModStorageService Storage { get; }

        /// <summary>Gets owner-scoped named input actions.</summary>
        IInputService Input { get; }

        /// <summary>Gets game-loop timing samples.</summary>
        IGameTime Time { get; }

        /// <summary>Gets lifetime-cancelled main-thread scheduling.</summary>
        IModScheduler Scheduler { get; }

        /// <summary>Gets the current player and center-screen aim state.</summary>
        ...
        /// <summary>Gets owner-scoped interaction registration and focus state.</summary>
        IInteractionService Interactions { get; }

        /// <summary>Gets held-item, give, and drop operations.</summary>
        IItemService Items { get; }

        /// <summary>Gets safe package asset loading and prefab spawning.</summary>
        IAssetService Assets { get; }

        /// <summary>Gets framework audio-cue playback.</summary>
        IAudioService Audio { get; }

        /// <summary>Gets TopiaForgeUi-backed HUD, window, modal, and toast operations.</summary>
        IUiService Ui { get; }
