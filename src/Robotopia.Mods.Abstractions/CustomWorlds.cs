...
namespace Robotopia.Mods
{
    ...
    {
        /// <summary>The freeform Sandbox gamemode registered by robotopia.worlds.</summary>
        public const string SandboxGamemodeId = "robotopia.worlds.sandbox";

        /// <summary>The generated Open Sandbox world registered by robotopia.worlds.</summary>
    ...
    /// bundle is loaded on first launch through <c>IAssetBundleService</c> (robotopia.assets), which
