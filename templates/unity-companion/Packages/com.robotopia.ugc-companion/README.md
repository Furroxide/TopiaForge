# Robotopia UGC Companion (Unity Editor)
...
2. Tag objects with **Robotopia UGC** markers (Add Component → *Robotopia UGC*):
...
3. Open **Robotopia → UGC Live Sync**, set the **Export root** and the game's **watch folder**
   (the folder the `Robotopia.UgcLiveSync` mod is configured to watch), then turn **Live Sync ON**.
