...
- The game-QA policy change was merged by the user.
...
- **Scope:** full requirements, with all game QA optional. IP, OSS, PRIV and CRED stay blocking. `P0-GAME-01` becomes advisory with an owner disposition; `P1-UX-01`, `P1-E2E-01` and the Sandbox native matrix get owner dispositions. I reviewed and merged that change; GAME stays blocked, never approved.
