...
| Gameplay abilities | Abstractions player, entity, physics, time, and scheduler services | GravityGun and SDK Acceptance Mod | [Modding reference](Modding.md) | Player/entity/physics/time/scheduler fakes | Loop phases, player health/control, ten in-session resource cycles plus repeated offline load/unload/failure cycles |
