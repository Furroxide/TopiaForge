...
| Interactions and creator content | Abstractions interactions/items/assets/audio plus Creator Content | Sandbox and SDK Acceptance Mod | [Sandbox](Sandbox.md) | Interaction/item/asset/audio plus creator catalog/project/mutation fakes | Queries, items, prefabs, authenticated catalogs, reversible sessions, project storage, and graceful failure |
| Worlds and modes | Abstractions scenes and detailed transition events, and Worlds | Zombies and SDK Acceptance Mod | [Custom worlds](CustomWorlds.md) and [Core services](CoreServices.md#scene-transition-semantics) | Scene/event and world/gamemode fakes | Initial scene and session teardown |
