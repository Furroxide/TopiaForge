...
| Worlds and modes | Abstractions scenes, Worlds, and UGC | SDK Acceptance Mod | [Custom worlds](CustomWorlds.md) | Scene, world/gamemode, and UGC fakes | Initial scene and session teardown |
| Robots and story | RobotKit | Sandbox, Zombies, and SDK Acceptance Mod | [RobotKit](RobotKit.md) | Full RobotKit fake suite | Robot body, movement, objectives, dialogue, voice, brain query |
