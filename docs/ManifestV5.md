---
title: Retired Manifest V5
description: Migration notice for the retired pre-release TopiaForge manifest schema.
---

# Retired Manifest V5

Manifest V5 is retired for TopiaForge packages targeting Robotopia. The loader, launcher and CLI accept
[Manifest V6](ManifestV6.md). The V5 schema is an always-rejecting stub,
