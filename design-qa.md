...
- Fonts and typography: Quicksand and Arista are declared through the shared UI package; headings, labels, and dense body text remain readable in both captured viewports.
